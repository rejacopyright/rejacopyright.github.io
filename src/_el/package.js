  ...
  return(
    <Fragment>
              ...
              <p className="m-0 lh-75 text-11 bold">rejajamil</p>
              {
                ...
                <div className="lh-13">
                  <span className="f-600 pr-2">
                    { Array(star).fill().map((r, key) => <img key={key} src={require('_assets/images/icons/star-fill.png').default} width="8" className="lh-0" alt=""/>) }
                    { Array(5 - star).fill().map((r, key) => <img key={key} src={require('_assets/images/icons/star-o.png').default} width="8" className="lh-0" alt=""/>) }
                  </span>
                </div>
              }
            </div>
          ...
          <div className="row m-0">
            ...
            <div className="col-12 py-0 pr-0 mt-2">
              <div className="bg-light p-2 radius-5">
                <div className="center-left text-dark">
                  { props.vendorAvatar && <div className="same-30 radius-50 bg-img" style={{backgroundImage: `url(${props.vendorAvatar || require('_dummy/img.png').default})`}} alt="" /> }
      ...
      <Modal id={props.id || 'review-image'} headerDisabled modalClass={`my-0 ${props.modalClass}`} bodyClass="p-0" contentClass="border-0 radius-0 bg-none">
        <Images dots={props.dots} arrows={props.arrows} img={[require('_dummy/images/3.jpg').default, require('_dummy/images/6.jpg').default, require('_dummy/images/4.jpg').default]} />
      </Modal>
    </Fragment>
  )
}
    ...
    <div className={`${props.className}`}>
      {
        ...
        <div className="center py-2">
          <Link from="/" to="/vendor/rejajamil" className="pl-2">
            <img className="same-30 radius-100 ppx-1 border border-gray" src={require('_dummy/img.png').default} alt=""/>
          </Link>
        ...
        <Slider {...settings}>
          {
            img.map((r, key) => (
              <div className="text-center" key={key}>
                <img className="w-100" src={`${r || require('_dummy/img.png').default}`} alt=""/>
              </div>
            ))
          }
        </Slider>
        ...
        <div className="row mx-0">
          {
            Array(5).fill().map((r, key) => (
              <div className="col-12 oh py-1 px-0" key={key}>
                <Review img={[require('_dummy/images/1.jpg').default, require('_dummy/images/2.jpg').default, require('_dummy/images/3.jpg').default]}  modalClass="m-0" star={props.star} avatar={require('_dummy/avatar/c-1.png').default} />
              </div>
            ))
          }
        </div>
...
export function Grid(props){
  return(
    <Link to='/package/123/123' className="text-dark">
      <div className="bg-white oh">
        <div className="position-relative">
          <div className="hpx-150 w-100 oh bg-img" style={{ backgroundImage: `url(${props.img || require('_dummy/img.png').default})` }}> </div>
          {
            props.promo &&
          ...
          }
          {
            ...
            <div className="position-absolute lh-1 l-0 b-0 p-1">
              <div className="radius-50 center ppx-4 white-50 same-20">
                <img src={require('_dummy/icons/love-fill.png').default} className="pointer hover w-100" alt=""/>
              </div>
            </div>
          }
        </div>
        <div className="p-1 position-relative">
          <div className={`center-left ${props.avatar && 'pb-1'}`}>
            {
              props.avatar &&
              <div className="pr-1">
                <img className="same-25 radius-100 ppx-1 border border-gray" src={(props.avatar && props.avatar !== true) ? props.avatar : require('_dummy/avatar.png').default} alt=""/>
              </div>
            }
            <div className="">
          ...
          <div className="row m-0 center">
            <div className="col px-0 lh-0">
              <img src={require('_assets/images/icons/star-fill.png').default} width="8" alt=""/>
...
export function List(props){
  ...
  return(
    <Link to={`/package/${props.username || 'username'}/123`}>
      <div className={`row flex-nowrap mx-0 border bg-white radius-5 oh relative ${props.className}`} ref={height}>
        <div className="col-auto p-0">
          <div className="bg-img" style={{backgroundImage: `url(${props.img || require('_dummy/img.png').default})`, width: h, height: h}} alt="" />
        </div>
        <div className="col p-2 text-dark text-left truncate">
          ...
          <div className="f-600 lh-1 text-left">
            <img src={require('_assets/images/icons/star.png').default} width="9" className="lh-0" alt=""/>
            <span className="bold text-8"> 3/5 </span>
            <img src={require('_assets/images/icons/love.png').default} width="9" className="lh-0 ml-2" alt=""/>
            <span className="bold text-8"> 3/5 </span>
          </div>
