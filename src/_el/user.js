...
export function Following(props){
  ...
  return(
    <Slider {...settings}>
      <div className="text-center px-1"> <img className="w-100 radius-100 ppx-2 border border-gray" src={require('_dummy/images/5.jpg').default} alt=""/> <p className="m-0 text-8 f-600 truncate lh-12">Reja Jamil</p> </div>
      <div className="text-center px-1"> <img className="w-100 radius-100 ppx-2 border border-gray" src={require('_dummy/images/6.jpg').default} alt=""/> <p className="m-0 text-8 f-600 truncate lh-12">Reja Jamil</p> </div>
      <div className="text-center px-1"> <img className="w-100 radius-100 ppx-2 border border-gray" src={require('_dummy/images/3.jpg').default} alt=""/> <p className="m-0 text-8 f-600 truncate lh-12">Reja Jamil</p> </div>
      <div className="text-center px-1"> <img className="w-100 radius-100 ppx-2 border border-gray" src={require('_dummy/images/5.jpg').default} alt=""/> <p className="m-0 text-8 f-600 truncate lh-12">Reja Jamil</p> </div>
      <div className="text-center px-1"> <img className="w-100 radius-100 ppx-2 border border-gray" src={require('_dummy/images/6.jpg').default} alt=""/> <p className="m-0 text-8 f-600 truncate lh-12">Reja Jamil</p> </div>
      <div className="text-center px-1"> <img className="w-100 radius-100 ppx-2 border border-gray" src={require('_dummy/images/7.jpg').default} alt=""/> <p className="m-0 text-8 f-600 truncate lh-12">Reja Jamil</p> </div>
    </Slider>
  )
}
      ...
      <div className="col p-2">
        <Link to={`/${props.username || 'username'}`}>
          <div className="center-left text-dark">
            <div className="same-50 radius-50 bg-img" style={{backgroundImage: `url(${props.img || require('_dummy/images/1.jpg').default})`}} alt="" />
            <div className="pl-2">
    ...
    <div className="row mx-0">
      <div className={`col oh ${props.className}`}>
        <div className={`relative radius-5 p-2 ${props.bodyClass}`}>
          <div className="center-left text-dark">
            <div className={`${(props.size || 'same-40')} radius-50 bg-img`} style={{backgroundImage: `url(${props.img || require('_dummy/images/1.jpg').default})`}} alt="" />
            <div className="pl-2">
  ...
  return(
    <div className="bg-white py-2 center-left mb-2">
      <div className="col-auto">
        <Link to="/chat/123"> <div className={`${props.size || 'same-40'} radius-50 bg-img`} style={{backgroundImage: `url(${props.img || require('_dummy/images/1.jpg').default})`}} alt="" /> </Link>
      </div>
  ...
  return(
    <Fragment>
      <div className="center-left p-1">
        <div className="pl-2">
          <img className="same-75 border border-gray ppx-1 radius-100 bg-img" src={`${props.img || require('_dummy/avatar.png').default}`} alt="" />
        </div>
