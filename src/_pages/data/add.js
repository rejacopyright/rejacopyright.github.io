...
import { Input, Textarea, Desimal, Radio, Checkbox } from '_components/form'
  ...
  return(
    <form>
      ...
      <div className="form-group row">
        ...
        {
          percent ?
          <Desimal sm ref={ref} name="value" rowClass="col-md-6" title={`Persentase / bln dari "Basic Salary"`} placeholder={`Persentase dari "Basic Salary"`} value={''} max="100" icon="%" right />
          :
          <Desimal sm ref={ref} name="value" rowClass="col-md-6" title={`Nominal / bln (Rupiah)`} placeholder={`Nominal (Rupiah)`} value={''} icon="Rp." />
        }
      </div>
      {/* Line 4 */}
      <div className="row">
