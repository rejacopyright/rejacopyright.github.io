        ...
        <div className="col-md-6">
          <div className="shadow-sm p-3 radius-10 mb-4">
            <div className="row">
              ...
              <Desimal sm rowClass="col-12 mb-2" name="tk" value={1000} title="TK (Tidak Kawin)" placeholder="0" icon="Rp. " />
              <Desimal sm rowClass="col-12 mb-2" name="k" value={1000} title="K (Kawin)" placeholder="0" icon="Rp. " />
              <Desimal sm rowClass="col-12 mb-2" name="ki" value={1000} title="K/I (NPWP Suami & Istri digabung)" placeholder="0" icon="Rp. " />
            </div>
          </div>
        </div>
        {/* TANGGUNGAN */}
        <div className="col-md-6">
          <div className="shadow-sm p-3 radius-10 mb-4">
            <div className="row">
              ...
              <Desimal sm rowClass="col-12 mb-2" name="tanggungan" value={1000} title="Tanggungan" placeholder="0" icon="Rp. " />
              <Desimal sm rowClass="col-12 mb-2" name="max" value={1000} title="Maksimal Tanggungan" placeholder="0" icon="Orang" right />
            </div>
          </div>
        </div>
      </div>
