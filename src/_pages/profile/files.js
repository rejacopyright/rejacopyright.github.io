  ...
  return(
    <div className="">
      ...
      <div className="card mb-2 shadow-none border">
        <div className="p-1 px-2">
          <div className="row align-items-center">
            <div className="col-auto"> <img src={require("_dummy/images/3.jpg").default} className="avatar-sm rounded" alt="files" /> </div>
      ...
      <div className="card mb-2 shadow-none border">
        <div className="p-1 px-2">
          <div className="row align-items-center">
            <div className="col-auto"> <img src={require("_dummy/images/6.jpg").default} className="avatar-sm rounded" alt="files" /> </div>
