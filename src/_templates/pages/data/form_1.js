...
import { Input, Decimal, Textarea } from '_components/form'
        ...
        <div className="col-12">
          <div className="shadow-xl radius-10 px-3 py-1 mb-3">
            <div className="row">
              ...
              <Decimal sm rowClass="col-md-6 mb-2" name="gaji" title="Gaji Pokok" placeholder="Gaji Pokok" icon="Rp." />
              <Decimal sm rowClass="col-md-6 mb-2" name="makan" title="Uang Makan" placeholder="Uang Makan" icon="Rp." />
