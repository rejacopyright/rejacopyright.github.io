          ...
          <ul className="message-list mb-1">
            <li className="h-unset lh-unset radius-5">
              <form className="center p-2" onSubmit={plus}>
                <Decimal sm rowClass="col mb-1" name="nm" title="Nominal" placeholder="0" icon="Rp." />
                <Decimal sm rowClass="col mb-1" name="pj" title="Pajak" placeholder="0" icon="%" max="100" right />
