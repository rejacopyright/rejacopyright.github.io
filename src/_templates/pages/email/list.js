        ...
        <li className="h-unset lh-unset radius-5">
          <div className="row m-0 p-2 align-items-center right-bar-toggle pointer">
            <Link className="col-atuo" to={`${props.link || '#'}`} >
              <span className="same-25 radius-100 center oh border border-gray"> <img src={require(`${process.env.REACT_APP_IMAGES}/avatar/c-1.png`).default} alt="" className="h-100"/> </span>
            </Link>
