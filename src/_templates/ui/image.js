...
function Hover2(){
  return(
    <div className="same-150 mx-auto oh bg-img radius-5" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/2.jpg`).default})` }}>
...
function Hover3(){
  return(
    <div className="same-150 mx-auto oh bg-img radius-5" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default})` }}>
...
function Hover4(){
  return(
    <div className="same-150 mx-auto oh bg-img radius-5" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/3.jpg`).default})` }}>
...
// CENTERED COVER
function Centered1(){
  return <div className="same-150 mx-auto oh bg-img" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/v.jpg`).default})` }}> </div>
}
function Centered2(){
  return <div className="same-150 mx-auto oh bg-img" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/h.jpg`).default})` }}> </div>
}
// CENTERED RESPONSIVE
function Responsive(){
  ...
  return <div ref={productImg} className="w-100 mx-auto radius-10 oh bg-img" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/3.jpg`).default})`, height: productHeight }}> </div>
}
// CENTERED COVER
function Contain1(){
  return <div className="same-150 mx-auto oh bg-img-c border border-gray border-dashed radius-10 bg-light" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/v.jpg`).default})` }}> </div>
}
function Contain2(){
  return <div className="same-150 mx-auto oh bg-img-c border border-gray border-dashed radius-10 bg-light" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/h.jpg`).default})` }}> </div>
}
function Contain3(){
  return <div className="same-150 mx-auto oh bg-img-c border border-gray border-dashed radius-10 bg-light" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/1.jpg`).default})` }}> </div>
}
// STYLE
function Radius0(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-100" alt=""/>
}
function Radius10(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-100 radius-10" alt=""/>
}
function Radius20(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-100 radius-20" alt=""/>
}
function Radius100(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-100 radius-100" alt=""/>
}
function RadiusBorder(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-100 radius-100 border border-1 border-gray p-1" alt=""/>
}
// SIZE
function Size200(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-200" alt=""/>
}
function Size150(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-150" alt=""/>
}
function Size100(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-100" alt=""/>
}
function Size50(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-50" alt=""/>
}
function Size25(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="same-25" alt=""/>
}
// AVATAR
function AvatarXS(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="avatar-xs" alt=""/>
}
function AvatarSM(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="avatar-sm" alt=""/>
}
function Avatar(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="avatar" alt=""/>
}
function AvatarMD(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="avatar-md" alt=""/>
}
function AvatarLG(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="avatar-lg" alt=""/>
}
function AvatarXL(){
  return <img src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} className="avatar-xl" alt=""/>
}
