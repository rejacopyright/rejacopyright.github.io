...
function Profile2(){
  return(
    <div className="profile-widget bg-white radius-10 shadow oh mb-3">
      <div className="hpx-100 w-100 mx-auto oh bg-img" style={{ backgroundImage: `url(${require('_dummy/images/6.jpg').default})` }}> </div>
      ...
      <div className="text-center p-0">
        <div className="profile-info px-3 pb-3">
          <img src={require('_dummy/images/6.jpg').default} alt="" className="img-thumbnail avatar-xl rounded-circle" />
    ...
    <div className="profile-widget p-3 bg-white radius-10 shadow oh mb-3">
      <div className="media">
        <div className="center-left">
          <img src={require('_dummy/images/6.jpg').default} className="avatar-lg radius-50" alt=""/>
      ...
      <div className="row mt-2 mx-0">
        <div className="col px-1"> <img src={require('_dummy/images/3.jpg').default} alt="" className="img-fluid radius-5" /> </div>
        <div className="col px-1"> <img src={require('_dummy/images/5.jpg').default} alt="" className="img-fluid radius-5" /> </div>
        <div className="col px-1"> <img src={require('_dummy/images/6.jpg').default} alt="" className="img-fluid radius-5" /> </div>
      </div>
      <hr className="my-2"/>
      <div className="row">
        <div className="col text-center pr-1">
...
function Product1(){
  return(
    <div className="radius-10 mb-3 bg-white shadow oh">
      <img src={require('_dummy/images/1.jpg').default} className="w-100" alt=""/>
      <div className="p-3">
  ...
  return(
    <div className="radius-10 mb-3 bg-white shadow oh">
      <div className="position-relative">
        <img src={require('_dummy/images/3.jpg').default} className="w-100" alt=""/>
        ...
        <div className="position-absolute lh-1 l-0 b-0 p-1">
          <div className="bg-success p-1 radius-20">
            <img src={require('_dummy/icons/free-shipping-white.png').default} width="20" alt=""/>
          </div>
        </div>
      </div>
      <div className="p-3 position-relative">
        ...
        <div className="my-1 text-9 center-left">
          <img src={require('_dummy/icons/super.png').default} width="15" alt=""/>
...
function Product3(){
  return(
    <div className="radius-10 mb-3 bg-white shadow oh">
      <div className="position-relative">
        <img src={require('_dummy/images/4.jpg').default} className="w-100" alt=""/>
        <div className="position-absolute lh-1 r-0 t-0">
          <span className="badge badge-danger">25% OFF</span>
        </div>
      </div>
...
function Product4(){
  return(
    <div className="radius-10 mb-3 bg-white shadow oh">
      <div className="position-relative">
        <img src={require('_dummy/images/5.jpg').default} className="w-100" alt=""/>
        <div className="position-absolute lh-1 r-0 t-0">
          <span className="badge badge-danger">25% OFF</span>
        </div>
      </div>
      ...
      <div className="px-3 pt-3 pb-2 position-relative">
        ...
        <div className="row center">
          <div className="col-auto">
            <img src={require('_assets/images/icons/love.png').default} width="20" className="pointer hover" alt=""/>
          </div>
...
function Product6(){
  return(
    <div className="radius-10 mb-3 bg-white shadow oh position-relative">
      <img src={require('_dummy/images/2.jpg').default} className="w-100" alt=""/>
