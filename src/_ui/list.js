...
function List1(){
  return(
    <div className="shadow-xs hover-sm bg-white radius-5 p-1 mt-1 center-left">
      <img src={require('_dummy/images/6.jpg').default} className="avatar radius-5 mr-2" alt="" />
      <div className="">
      ...
      <div className="dropdown ml-auto">
        ...
        <div className="dropdown-menu dropdown-menu-right radius-5 oh">
...
function List3(){
  return(
    <div className="shadow-sm hover-md bg-white radius-5 p-2 mt-1 center-left">
      <img src={require('_dummy/images/6.jpg').default} className="avatar-sm radius-50 mr-2" alt="" />
      <div className="">
...
function List4(){
  return(
    <div className="row mx-0 shadow-sm border hover-md bg-white radius-5 mt-1 oh position-relative">
      <div className="col-auto same-100 mr-2 bg-img" style={{ backgroundImage: `url('${require('_dummy/images/6.jpg').default}')` }}> </div>
      <div className="col px-1 py-2">
        ...
        <div className="lh-1">
          <Rating
            initialRating={3}
            fullSymbol={<img src={require('_assets/images/icons/star.png').default} width="9" alt=""/>}
            emptySymbol={<img src={require('_assets/images/icons/star-o.png').default} width="8" alt=""/>}
            readonly
            />
    ...
    <div className="row mx-0 p-2 shadow-sm border hover-md bg-white radius-5 mt-1 oh position-relative">
      <div className="col">
        <div className="row center">
          <div className="col-auto">
            <img className="same-40 radius-50 border border-1 bg-img" src={require('_dummy/images/6.jpg').default} alt="" />
          </div>
      ...
      <div className="col-auto center-right">
        <div className="text-right">
          <div className="same-100 radius-5 bg-img" style={{ backgroundImage: `url('${require('_dummy/images/5.jpg').default}')` }}> </div>
