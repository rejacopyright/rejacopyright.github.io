                ...
                <div className="row flex-nowrap m-0">
                  <div className="col-md-7 d-none d-md-flex align-items-center oh border-right">
                    <div className="">
                      ...
                      <ul className="px-0">
                        <li onClick={autoLogin} className="text-10 my-2 i text-muted"><code>Package Page (dev)</code> in vendor <Link to={{pathname: '/vendor/package', autoLogin: true}} className="ml-1 small">[Link]</Link></li>
