              ...
              <div className="dropdown-menu dropdown-menu-right dropdown-sm">
                ...
                <div className="slimscroll noti-scroll">
                  <Link to="#" className="dropdown-item notify-item border-bottom center-left">
                    <div className="same-25"> <img src={require(`${process.env.REACT_APP_IMAGES}/avatar/c-1.png`).default} className="img-fluid rounded-circle" alt="img" /> </div>
                  ...
                  <Link to="#" className="dropdown-item notify-item border-bottom center-left">
                    <div className="same-25"> <img src={require(`${process.env.REACT_APP_IMAGES}/avatar/c-2.png`).default} className="img-fluid rounded-circle" alt="img" /> </div>
                    <div className="ml-2 mxw-200">
