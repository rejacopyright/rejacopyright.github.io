      ...
      <div className="row m-0 ppx-2">
        {
          Array(2).fill().map((r, key) => (
            <div className="col-12 col-md-6 col-xl-4 ppx-1" key={key}> <Vendor img={`${api.img}/sample/${key+1}.jpg`} username="rejajamil" /> </div>
          ))
        }
      </div>
      <div className="row m-0 ppx-2">
        {
          Array(8).fill().map((r, key) => (
            <div className="col-6 col-md-3 col-xl-2 ppx-1" key={key}> <Package img={`${api.img}/sample/${key+1}.jpg`} username avatar={`${api.img}/sample/${key+1}.jpg`} /> </div>
          ))
        }
      </div>
    </div>
