...
import {Detail as Product} from '_el/product'
            ...
            <div className="radius-5 bg-white oh pointer">
              <Link to="/product/123/123">
                <div className="position-relative">
                  ...
                  <div ref={productImg} className="w-100 mx-auto oh bg-img" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/${key+2}.jpg`).default})`, height: productHeight }}> </div>
...
function RecomendedProduct(props){
  const productImg = useRef()
  const [productHeight, productHeightSet] = useState('0px')
  const settings = {
    dots: true,
            ...
            <div className="radius-5 mb-2 bg-white shadow-sm oh pointer">
              <Link to="/product/123/123">
                <div className="position-relative">
                  ...
                  <div ref={productImg} className="w-100 mx-auto oh bg-img" style={{ backgroundImage: `url(${require(`${process.env.REACT_APP_IMAGES}/products/${key+4}.jpg`).default})`, height: productHeight }}> </div>
                  <div className="position-absolute lh-1 r-0 b-0">
                    <span className="badge badge-danger">25% OFF</span>
                  </div>
                </div>
    ...
    <div className={`row ${props.className}`}>
      <div className="col-4 mb-4">
        <div className="sticky-top t-10">
          ...
          <Slider {...settings} className="mt-2 mx-n1">
            <div className="text-center img-item px-1" onMouseOver={e => image(3, e)}> <img className="w-100 radius-10" src={require(`${process.env.REACT_APP_IMAGES}/products/3.jpg`).default} alt=""/> </div>
            <div className="text-center img-item px-1" onMouseOver={e => image(5, e)}> <img className="w-100 radius-10" src={require(`${process.env.REACT_APP_IMAGES}/products/5.jpg`).default} alt=""/> </div>
            <div className="text-center img-item px-1" onMouseOver={e => image(6, e)}> <img className="w-100 radius-10" src={require(`${process.env.REACT_APP_IMAGES}/products/6.jpg`).default} alt=""/> </div>
            <div className="text-center img-item px-1" onMouseOver={e => image(1, e)}> <img className="w-100 radius-10" src={require(`${process.env.REACT_APP_IMAGES}/products/1.jpg`).default} alt=""/> </div>
            <div className="text-center img-item px-1" onMouseOver={e => image(2, e)}> <img className="w-100 radius-10" src={require(`${process.env.REACT_APP_IMAGES}/products/2.jpg`).default} alt=""/> </div>
            <div className="text-center img-item px-1" onMouseOver={e => image(4, e)}> <img className="w-100 radius-10" src={require(`${process.env.REACT_APP_IMAGES}/products/4.jpg`).default} alt=""/> </div>
          </Slider>
        </div>
      </div>
      <div className="col-8">
        <div className="card">
          <div className="card-body shadow-sm radius-10 oh">
            ...
            <div className="f-600 center-left mb-3">
              <Rating
                initialRating={4}
                fullSymbol={<img src={require(`${process.env.REACT_APP_IMAGES}/icons/star.png`).default} width="15" alt=""/>}
                emptySymbol={<img src={require(`${process.env.REACT_APP_IMAGES}/icons/star-o.png`).default} width="15" alt=""/>}
                readonly
                />
            ...
            <div className="center-left text-10">
              <div className="bold m-0 center-left"><img src={require(`${process.env.REACT_APP_IMAGES}/icons/heart-red.png`).default} className="mr-1" height="15" alt=""/><div className="lh-0">192 Menyukai</div></div>
              <div className="bold m-0 px-2">|</div>
              <div className="bold m-0 center-left"><img src={require(`${process.env.REACT_APP_IMAGES}/icons/comment.png`).default} className="mr-1" height="15" alt=""/><div className="lh-0">3.221 Ulasan</div></div>
              <div className="bold m-0 px-2">|</div>
              <div className="bold m-0 center-left"><img src={require(`${process.env.REACT_APP_IMAGES}/icons/check-success.png`).default} className="mr-1" height="15" alt=""/><div className="lh-0">429 Transaksi Berhasil</div></div>
            </div>
            <div className="p-3 bg-smoke radius-5 mt-3">
              ...
              <div className="center-left mt-1">
                <img src={require(`${process.env.REACT_APP_IMAGES}/logo/logo.png`).default} height="25" alt=""/>
      ...
      <div className="col-12 sticky-top b-2 t-9">
        <div className="row m-0 py-2 radius-10 shadow border border-light bg-white">
          <div className="col">
            <Vendor info className="px-0" btnClass="ml-auto" followClass="bg-soft-success text-success" img={`${require(`${process.env.REACT_APP_IMAGES}/sample/1.jpg`).default}`} name="Reja Jamil" username="rejajamil" />
          </div>
          ...
          <div className="col-auto center-left">
            <img src={require(`${process.env.REACT_APP_IMAGES}/icons/love.png`).default} alt="" className="same-15 mr-1"/>
            <div className="text-10 f-700 pointer u">Favoritkan</div>
          </div>
          <div className="col-auto center-left">
            <img src={require(`${process.env.REACT_APP_IMAGES}/icons/chat.png`).default} alt="" className="same-15 mr-1"/>
      ...
      <div className="col-12 my-2">
        <div className="card m-0">
          <div className="card-body shadow-none radius-10 pt-2 pb-0 px-0 bg-white">
            ...
            <hr className="mt-1 mb-2" />
            <div className="mb-2"> <RecomendedProduct /> </div>
            <div className="mb-2"> <OtherProduct /> </div>
          </div>
        </div>
      </div>
    </div>
  ...
  return(
    <Fragment>
      ...
      <div className="container-fluid pb-2 pb-md-3">
        <Product className="phone" star={9} img={[`${require(`${process.env.REACT_APP_IMAGES}/sample/1.jpg`).default}`, `${require(`${process.env.REACT_APP_IMAGES}/sample/2.jpg`).default}`, `${require(`${process.env.REACT_APP_IMAGES}/sample/3.jpg`).default}`]}/>
        <ProductDesktop className="desktop mt-2" />
        <div style={{paddingTop: bottom}} />
      </div>
      <Bottombar ref={bottomBar}>
        <div className="row center p-2 m-0 shadow-md">
          <div className="col-auto">
            <img src={require(`${process.env.REACT_APP_IMAGES}/icons/love.png`).default} alt="" className="same-25"/>
          </div>
          <div className="col-auto">
            <img src={require(`${process.env.REACT_APP_IMAGES}/icons/chat.png`).default} alt="" className="same-25"/>
          </div>
